    ...
    return (
        <div className="hero min-h-screen">
            ...
            <div className="hero-content flex flex-col gap-6 md:gap-0 md:flex-row">
                ...
                <div className="rounded-lg md:rounded-r-lg md:rounded-l-none w-full max-w-sm shadow-2xl bg-gradient-to-r from-slate-200 to-[#e3c7b4]">
                    <form className="card-body">
                        ...
                        <div className="form-control mt-6">
                            <button className="btn bg-orange-500 text-white font-bold">Register</button>
                        </div>
