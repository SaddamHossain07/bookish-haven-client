...
const ReadingBook = () => {
    ...
    return (
        <div ref={targetRef} className="max-w-[1280px]">
            ...
            <div className="w-10/12 mx-auto mt-24 flex flex-col md:flex-row justify-between">
                <div>
                ...
                <button onClick={() => toPDF()} className="bg-orange-500 px-10 py-4 mt-6 md:mt-auto text-white font-semibold rounded-md hover:bg-orange-600"><BiSolidDownload className="inline-block mr-2 text-2xl"></BiSolidDownload>PDF Download</button>
            </div>
            ...
            <div className="w-10/12 mx-auto mt-10 flex flex-col md:flex-row gap-10">
                ...
                <div className="w-full md:w-1/2 h-[500px] flex flex-col justify-between overflow-hidden">
